...
const ImportHouseholdModal = ({ open, onClose, onSuccess }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://localhost:5000/api/households/import-preview",
        form,
  ...
  const handleConfirm = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await axios.post(
        "http://localhost:5000/api/households/import-confirm",
        { rows: previewRows },
  ...
  const columns = [
    ...
    { field: "head_count", headerName: "Head Count",  width: 110, editable: true, type: "number", align: "left", headerAlign: "left" },
    {
...
export default ImportHouseholdModal;